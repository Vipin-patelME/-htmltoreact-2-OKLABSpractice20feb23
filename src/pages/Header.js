                ...
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                    <div className="container px-5">
                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <a className="nav-link dropdown-toggle" id="navbarDropdownBlog" href="/about" role="button" data-bs-toggle="dropdown" aria-expanded="false">Blog</a>
                            ...
                            <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" id="navbarDropdownPortfolio" href="/aboutS" role="button" data-bs-toggle="dropdown" aria-expanded="false">Portfolio</a>
